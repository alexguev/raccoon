...
#include "ADSolidDeformationTotal.h"
#include "MooseVariable.h"
#include "libmesh/quadrature.h"
#include <limits>

registerMooseObject("raccoonApp", ADSolidDeformationTotal);

InputParameters
ADSolidDeformationTotal::validParams()
{
...
ADSolidDeformationTotal::ADSolidDeformationTotal(const InputParameters & parameters)
...
ADReal
ADSolidDeformationTotal::computeQpResidual()
{
